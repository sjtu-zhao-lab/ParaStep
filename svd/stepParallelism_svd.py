...
from .svd_stepParallelism_call import step_parallelism_call

StableVideoDiffusionPipeline.__call__ = step_parallelism_call



class StepParallelism(object):
    def __init__(self, pipeline, step_size, warm_up = 5):
